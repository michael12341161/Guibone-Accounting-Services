...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2026 at 03:06 AM
...
(31, 21, 1, 'module_permission_granted', 'Dashboard Access Granted: Admin admin granted you access to Dashboard.', 0, '2026-04-19 22:02:17'),
(32, 21, 1, 'module_permission_granted', 'Module Access Granted: Admin admin granted you access to Client Management, Documents, Business Status, Appointments, Tasks, Calendar, Work Update, Messaging, and Reports.', 0, '2026-04-19 22:04:32'),
(33, 22, 1, 'module_permission_granted', 'Module Access Granted: Admin admin granted you access to Dashboard, Calendar, Work Update, and Messaging.', 0, '2026-04-19 22:08:10'),
...
(21, 'dong', '$2y$10$6vTkPlrWtNgkmzF6EyeBfuGCQozGqMQNW2WFphtlQ8EOy2MaTLxBa', '2026-03-20 21:23:17', 0, NULL, 2, 3, 'dong@gmail.com', 'Domingo', 'E.', 'Ancog', NULL, '2026-03-20', '4234324', 4, '313213', '21212', NULL, '2026-03-20 13:23:17', '2026-04-20 01:04:48'),
(22, 'roberth', '$2y$10$5dj3hmZI/k67GniAX8wsRudBv386JmOQp3G9tAxfe2Gppmv6u80Iq', '2026-03-20 21:23:52', 0, NULL, 3, 3, 'roberth@gmail.com', 'Roberth', NULL, 'Namoc', NULL, '2026-03-20', '4234324', 3, '313213', '21212', NULL, '2026-03-20 13:23:52', '2026-04-20 00:52:06'),
...
--
ALTER TABLE `audit_logs`
  MODIFY `audit_logs_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `settings`
  MODIFY `Settings_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2765;
