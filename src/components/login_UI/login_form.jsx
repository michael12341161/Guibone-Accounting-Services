...
function ErrorIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="mt-0.5 h-3.5 w-3.5 flex-none">
      <path
        fillRule="evenodd"
...
export default function LoginForm({
  ...
  const createAccountClassName =
    "inline-flex w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-emerald-300 hover:text-emerald-700";

  return (
    <div className="relative overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_22px_70px_-54px_rgba(15,23,42,0.65)]">
      ...
      <div className="relative border-b border-slate-200 p-4 sm:p-5">
        ...
        <p className="mt-0.5 text-[11px] text-slate-500">Sign in to continue to your account.</p>
      </div>

      <form className="relative space-y-3.5 p-4 sm:p-5" onSubmit={onSubmit}>
        <AuthInput
          id="username"
        ...
        <AuthInput
          ...
          rightAdornment={
            <button
              ...
              className="rounded-lg px-1.5 py-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600"
        ...
        <div className="-mt-1 flex items-center justify-end">
          <button
            ...
            className="text-[11px] font-semibold text-emerald-700 transition hover:text-emerald-800 hover:underline"
          >
            Forgot password?
          </button>
        </div>
        ...
        <AuthButton type="submit" fullWidth loading={loading} loadingText="Signing in..." className="py-2.5">
          <span>Login</span>
          <ArrowRightIcon />
        </AuthButton>
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-400">New here?</p>
          <div className="h-px flex-1 bg-slate-200" />
        </div>
