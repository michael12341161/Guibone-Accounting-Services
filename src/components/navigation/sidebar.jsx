...
const expandedGroupNavItemClasses =
  "border-transparent bg-white text-slate-900 ring-slate-200 shadow-sm dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:ring-slate-700";
      ...
      >
        <ul className={collapsed ? "space-y-2" : "space-y-4"}>
          {items?.map((item) => {
            ...
            const isExpandedGroup = expandedGroupKey === item.key;
            const hasActiveChild = hasChildren ? Boolean(findMatchingNavItem(location.pathname, item.children)) : false;
            const isGroupMatch = hasChildren ? Boolean(findMatchingNavItem(location.pathname, [item])) : false;
                ...
                hasChildren ? (
                  <button
                    ...
                    className={classNames(
                      ...
                      isGroupMatch ? activeNavItemClasses : inactiveNavItemClasses,
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className={classNames(
                      ...
                      isExpandedGroup || hasActiveChild
                        ? expandedGroupNavItemClasses
                  ...
                  >
                    ...
                    <ChevronDown
                      className={classNames(
                        ...
                        isExpandedGroup ? "rotate-180 text-current" : "text-slate-400"
                      )}
                      strokeWidth={1.5}
                      aria-hidden="true"
                    />
