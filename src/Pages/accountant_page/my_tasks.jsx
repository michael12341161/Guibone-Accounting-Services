                        ...
                        <div className="min-w-0">
                          <div
                            className={`text-[11px] uppercase tracking-wide ${
                              pendingAccountantSteps.length > 0 ? "text-indigo-700" : "text-slate-500"
                            }`}
                          >
                            Assigned To You
                          </div>
                          <div
                            className={`mt-1 text-sm font-semibold ${
                              pendingAccountantSteps.length > 0 ? "text-indigo-950" : "text-slate-700"
                            }`}
                          >
                            {pendingAccountantSteps.length > 0
                          ...
                          <div
                            className={`mt-1 text-[11px] ${
                              pendingAccountantSteps.length > 0 ? "text-indigo-700/90" : "text-slate-500"
                            }`}
                          >
                            {pendingAccountantSteps.length > 0
                          ...
                          {accountantSteps.length > 0 && (
                            <span
                              className={`inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full px-1.5 text-[10px] font-bold ${
                                pendingAccountantSteps.length > 0 ? "bg-indigo-600 text-white" : "bg-slate-200 text-slate-600"
                              }`}
                            >
