...
import { api, DEFAULT_SECURITY_SETTINGS, fetchSecuritySettings, storeAuthToken } from "../../services/api";
...
export default function LoginPage() {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      ...
      setLoginError(responseData?.message || err?.monitoringUserMessage || err?.message || "Login failed");
