...
export default function AdminWorkUpdate() {
  ...
  const quickStats = useMemo(() => {
    ...
    tasks.forEach((t) => {
      ...
      if (s === "completed" || s === "done") data.completed += 1;
                        ...
                        return (
                          <div className="space-y-2">
                            {steps.map((step, i) => {
                              ...
                              const canComplete = !taskLocked && !done && canCompleteByOrder && isAssignedToOwner;
                              const canEditRemark = !taskLocked && !done && isAssignedToOwner;
